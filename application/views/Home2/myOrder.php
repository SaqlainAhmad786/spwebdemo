                        ...
                        <div class="col-md-12 mt-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-1">
                                            <i class="fa fa-arrow-left" style="font-size:22px"></i>
                                        </div>
                                        <div class="col-11">
                                            <b> Refund Credited </b> <br>
                                            <span> Your refund of ₹450.00 for return has been proccessed jeans </span>
                                    ...
                                    <div class="row mx-1 py-1 custom-bg-color">
                                        <div class="col-1 px-sm-1 px-0">
                                            <img src="<?= base_url('public/images/jeans.webp') ?>" class="object-fit-contain"
                                                alt="no-img">
                                        </div>
                                        <div class="col-10">
                                            <b> Refund Credited </b> <br>
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mx-1 py-1 custom-bg-color">
                                        <div class="col-1 px-sm-1 px-0">
                                            <img src="<?= base_url('public/images/shirt.webp') ?>" class="object-fit-contain"
                                                alt="no-img">
                                        </div>
                                        <div class="col-10">
                                            <b> Refund Credited </b> <br>
